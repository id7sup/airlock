 ...
 * 
 * Utilise les credentials du service account pour se connecter à Firestore
 * et Firebase Auth. Initialisé une seule fois au démarrage de l'application.
 */
...
/**
 * Instance Firebase Auth pour la gestion des utilisateurs
 */
