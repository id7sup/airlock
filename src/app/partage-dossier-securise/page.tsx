        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-[#f5f5f7] rounded-t-[48px] p-12 md:p-24 border-x border-t border-black/[0.03] space-y-24">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8">
              <div className="md:col-span-7 space-y-10 text-left">
                ...
                <div className="space-y-6 max-w-md">
                  <p className="text-2xl font-medium text-black/80 leading-tight">La nouvelle norme du partage de fichiers securise et souverain.</p>
                  <p className="text-lg text-black/40 font-medium">Developpe pour les equipes qui exigent un controle total sur leurs donnees.</p>
                </div>
              </div>
              <div className="md:col-span-5 grid grid-cols-3 gap-10 md:justify-items-end text-left">
                <div className="space-y-8">
                  ...
                  <ul className="space-y-5 text-[17px] text-black/40 font-medium">
                    ...
                    <li><Link href="/security" className="hover:text-black transition-colors">Securite</Link></li>
                ...
                <div className="space-y-8">
                  ...
                  <ul className="space-y-5 text-[17px] text-black/40 font-medium">
                    ...
                    <li><Link href="/partage-dossier-securise" className="hover:text-black transition-colors">Partage Securise</Link></li>
                ...
                <div className="space-y-8">
                  <h4 className="text-sm font-bold text-black uppercase tracking-[0.2em]">Legal</h4>
                  <ul className="space-y-5 text-[17px] text-black/40 font-medium">
                    <li><Link href="/confidentialite" className="hover:text-black transition-colors">Confidentialite</Link></li>
            ...
            <div className="pt-12 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-10">
              <div className="flex items-center gap-3 text-black/40 font-medium bg-white/50 px-4 py-2 rounded-full border border-black/[0.03]"><Compass className="w-4 h-4 text-[#96A982]" /><span>Francais</span><ChevronDown className="w-3 h-3 opacity-50" /></div>
