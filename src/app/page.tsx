...
import { ChevronDown, Compass, Search, MousePointer2, Layers, Database, Zap, LayoutDashboard, Activity, Timer, BarChart3, History, Power, ArrowRight, Lock, Eye, Download, ShieldCheck, RefreshCw, Menu, X, FileText } from "lucide-react";
        ...
        >
          <div className="flex items-center justify-between h-10 w-full">
            ...
            <div className="hidden md:flex items-center gap-6 text-[13px] font-medium tracking-tight">
              ...
              <Link href="/cas-usage" onMouseEnter={() => { setIsFeaturesHovered(false); setIsSecurityHovered(false); }} className="text-white/70 hover:text-white transition-colors">
                Cas d&apos;usage
              </Link>
              <Link href="/pricing" onMouseEnter={() => { setIsFeaturesHovered(false); setIsSecurityHovered(false); }} className="text-white/70 hover:text-white transition-colors">
                Facturation
              </Link>
              <button
