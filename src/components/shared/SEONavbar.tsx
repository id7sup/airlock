      ...
      >
        <div className="flex items-center justify-between h-10 w-full">
          ...
          <div className="hidden md:flex items-center gap-6 text-[13px] font-medium tracking-tight">
            ...
            <Link href="/cas-usage" className="text-white/70 hover:text-white transition-colors" onMouseEnter={() => { setIsFeaturesHovered(false); setIsSecurityHovered(false); }}>
              Cas d&apos;usage
            </Link>
            <Link href="/pricing" className="text-white/70 hover:text-white transition-colors" onMouseEnter={() => { setIsFeaturesHovered(false); setIsSecurityHovered(false); }}>
              Facturation
            </Link>
            <button
